...
func TestShowMoveTo(t *testing.T) {
	...
	kb := tg.NewKeyboard([]tg.Row{
		...
		[]tg.Btn{
			...
			{Name: "✅ To Today", Cmd: tg.Cmd{Name: "mv", Params: []string{"c5e7dfaf771", "0"}, Type: "cmd"}},
		},
...
func TestSaveToNewTask(t *testing.T) {
	...
	kb := tg.NewKeyboard([]tg.Row{
		...
		tg.NewRow(
			...
			tg.NewBtn("✅ To Today", tg.NewCmd("mv", []string{"c5e7dfaf771", "0"})),
		),
		tg.NewRow(
...
func TestSaveToExistingFile(t *testing.T) {
	...
	kb := tg.NewKeyboard([]tg.Row{
		...
		tg.NewRow(
			...
			tg.NewBtn("✅ To Today", tg.NewCmd("mv", []string{"c5e7dfaf771", "1"})),
		),
		tg.NewRow(
			tg.NewBtn("👌", tg.NewCmd("today", []string{})),
		),
